...
The RPMS (or DEBS, respectively) directory also contains a package named libreoffice25.8-freedesktop-menus-25.8.0.1-1.noarch.rpm (or libreoffice25.8-debian-menus_25.8.0.1-1_all.deb, respectively, or similar). This is a package for all Linux distributions that support the Freedesktop.org specifications/recommendations (https://en.wikipedia.org/wiki/Freedesktop.org), and is provided for installation on other Linux distributions not covered in the aforementioned instructions.
...
We hope you enjoy working with the new LibreOffice 25.8 and will join us online.
